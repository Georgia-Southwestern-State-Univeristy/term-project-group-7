...
- Adaptive learning paths driven by student performance
- Immediate formative feedback instead of delayed or summative-only assessment
...
The following features define the **minimum viable prototype** required for successful delivery within the course timeline.

### Student Functionality
- Secure account authentication with student-level permissions
- Personalized learning path based on assessment results
...
- Support for **at least one subject area** (mathematics, science, or reading)
...
### Scope Risks
- Expanding to multiple subjects prematurely
- Attempting to replicate full middle school curricula
- Overengineering analytics at the expense of core learning functionality
